...
import SocialNetwork_Example.scala.SocialNetworkUtilities;
import scala.Option;
import scala.Some;
import scala.Tuple2;
...
import static Helpers.ScalaInJavaHelper.linkedListToScalaIterable;

/**
 * Created by Samer Adra on 7/13/2015.
 */
public class UserStub extends NodeDataStub<UserTypeVal, User, UserTypes, UserStub> {
    final scala.Option None = scala.Option.apply(null);
    ...
    public UserStub(UserTypeVal userType, Tuple2<Double, Double> geographicalLocation, Boolean isSecret) {
        this();
        dataType = userType;
        this.geographicalLocation = new Some<Tuple2<Double,Double>>(geographicalLocation);
        this.isSecret = new Some<Boolean>(isSecret);
    }
    ...
    public scala.collection.Iterable<String> displayableElements() {
        ...
        if (geographicalLocation.nonEmpty()) {
            elements.add("Lat=" + geographicalLocation.get()._1().toString());
            elements.add("Long=" + geographicalLocation.get()._2().toString());
        }
    ...
    public static UserStub getStubWithRandomParams(UserTypeVal userType) {
        ...
        return new UserStub(userType, new Tuple2<Double,Double>((Double)tuple._1(), (Double)tuple._2()),
