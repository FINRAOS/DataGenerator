...
import org.finra.scaffolding.transformer.join.JoinFilter.JoinTypeName
import org.finra.scaffolding.transformer.join._
...
trait JoinService extends TransformationsProvider {
    ...
    val JoinsAnnotation: Class[org.finra.scaffolding.transformer.support.Joins] = classOf[org.finra.scaffolding.transformer.support.Joins]
