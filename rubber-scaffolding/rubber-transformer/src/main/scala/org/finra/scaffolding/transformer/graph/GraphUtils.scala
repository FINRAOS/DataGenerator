...
import org.finra.scaffolding.graph.GraphFactoryService
import org.finra.scaffolding.transformer.graph.generator.GraphScenarioGenerator
import org.finra.scaffolding.transformer.graph.nodes.NodeRepository
import org.finra.scaffolding.transformer.graph.reader.{GraphMLNode, GraphReaderOpts, GraphScenarioReader}
import org.finra.scaffolding.transformer.graph.rules.RuleConditionOptions
import org.finra.scaffolding.transformer.graph.traverser.{BreadthFirstGraphTraverser, GraphTraverser}
...
object GraphUtils {
    ...
    val rubberRandom = new org.finra.scaffolding.random.core.RubberRandomImpl()
