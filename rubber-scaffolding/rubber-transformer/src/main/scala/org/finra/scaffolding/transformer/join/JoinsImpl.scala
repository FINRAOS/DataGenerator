package org.finra.scaffolding.transformer.join
...
object JoinsImpl {
    ...
    implicit def apply(joins: org.finra.scaffolding.transformer.support.Joins)(implicit context: ContextProvider): JoinsImpl = {
        JoinsImpl(joins.value().toSet[org.finra.scaffolding.transformer.support.Join], joins.condition())
    }
