...
import org.finra.scaffolding.graph.{GraphAppConfiguration, GraphFactoryService}
import org.finra.scaffolding.spark.RDDService
import org.finra.scaffolding.transformer.graph.nodes.{EdgeContainer, ElementContainer, VertexContainer}
import org.finra.scaffolding.transformer.graph.reader.GraphMLUtils
import org.finra.scaffolding.transformer.graph.rules._
import org.finra.scaffolding.transformer.graph.traverser.BreadthFirstGraphTraverser
import org.finra.scaffolding.transformer.{Mailman, Person, Worker}
...
@ComponentScan(Array("org.finra.scaffolding.transformer.*", "org.finra.scaffolding.random.*"))
...
class GraphTest {
    ...
    def testSimple {
        ...
        <graphml>
            <graph>
                <node id="1">
                    <data key="_clazz">org.finra.scaffolding.transformer.Person</data>
                ...
                <edge id="99" source="1" target="2">
                    <data key="_clazz">org.finra.scaffolding.transformer.FriendsWith</data>
                </edge>
