package org.finra.scaffolding.random.core

import org.finra.scaffolding.config._
import org.finra.scaffolding.random.core.RubberRandom.ProtectedPackagesName
import org.finra.scaffolding.random.predicate._
import org.finra.scaffolding.random.strategy.{FieldGeneratingStrategy, GeneratingStrategy}
import org.finra.scaffolding.random.support.{AnnotationProcessor, CustomRandomizerProcessor}
import org.finra.scaffolding.random.types.{CollectionTypes, ParameterizedTypeReference, TypeContainer}
import org.finra.scaffolding.random.{Parameter, RandomProvider}
...
abstract class RubberRandom(
                               val basePackages: Seq[String] = Seq("org.finra.scaffolding"),
