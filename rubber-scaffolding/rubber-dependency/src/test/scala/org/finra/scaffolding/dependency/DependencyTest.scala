...
import org.finra.scaffolding.dependency.service.DependencyService
...
@ContextConfiguration(classes = Array(classOf[org.finra.scaffolding.graph.GraphAppConfiguration]))
