...
public class PairwiseCombiDataSetGenerator implements ICombiDataSetGenerator {
	...
	/**
	 * Generates the pairwise datasets by writing a temp file formatted for UnsychronizedAllPairs.java,
	 * running the pairwise algorithm on it, and creating datasets from the results.
	 * @param dataSpec
	 * @return
	 */
