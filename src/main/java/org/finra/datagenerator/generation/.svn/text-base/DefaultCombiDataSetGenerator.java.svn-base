...
public class DefaultCombiDataSetGenerator implements ICombiDataSetGenerator {
	...
	private static Logger LOG =Logger.getLogger(DefaultCombiDataSetGenerator.class);
	
	private static DefaultCombiDataSetGenerator instance = new DefaultCombiDataSetGenerator();
	...
	/**
	 * Fills out default data recursively by groups. Enforces group hierarchy and uniqueness
	 * requirements specified in the Data Spec.
	 * @param dataSet
	 */
