...
/**
 * This class is just a bundle of information that describes a
 * 'set property' requirement for the branch graph.
 * 
 * @author ChamberA
 *
 */
public class SetPropertyRequirement {
	...
	public SetPropertyRequirement clone() throws CloneNotSupportedException {
		return(new SetPropertyRequirement(this.variableAlias, this.property, this.value));
	}

	public SetPropertyRequirement(String variableAlias, String property, String value) {
