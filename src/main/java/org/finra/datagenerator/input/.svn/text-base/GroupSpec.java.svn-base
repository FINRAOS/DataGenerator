...
/**
 * Represent a specificiation for a group. Name, number per parent, elements that are required to be unique,
...
public class GroupSpec {
	...
	public int getNumPerParent() { return numPerParent; }
	public String getParentGroupType() { return parentGroupType; }
	public List<String> getUniqueElements() { return uniqueElements; }
	...
	/**
	 * If this group has uniqueness requirements, then this method will return the
	 * ith unique combination as vartype:value pairs, or throw an exception if all combinations
	 * have been exhausted.
	 * 
	 * @return
	 */
