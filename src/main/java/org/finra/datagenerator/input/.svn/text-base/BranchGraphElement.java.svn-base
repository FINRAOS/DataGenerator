...
/**
 * This interface is implemented by BranchGraphNode
 * and BranchGraphEdge. Both of these graph elements
 * can be annotated with requirements.
 * 
 * @author ChamberA
 *
 */
public interface BranchGraphElement {
