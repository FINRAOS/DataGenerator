 ...
 *-dataspec "C:\Users\MeleS\Desktop\Data Generator\input\spec.xls" -templates "C:\Users\MeleS\Desktop\Data Generator\input\template_PW.txt" -config "C:\Users\MeleS\Desktop\Data Generator\input\dd.properties" -out "C:\Users\MeleS\Desktop\Data Generator\output" -pairwise -f -isoNeg
 *
 *	Purcahse and Sales
 *-dataspec "C:\Users\MeleS\Desktop\Data Generator\input\Purchases and Sales\purchase_sales.xls" -templates "C:\Users\MeleS\Desktop\Data Generator\input\purchases and sales\Purch_Sales_Template.txt" -config "C:\Users\MeleS\Desktop\Data Generator\input\dd.properties" -out "C:\Users\MeleS\Desktop\Data Generator\output\Purchases and Sales" -pairwise -f -isoNeg
 *
 *-dataspec "C:\Users\MeleS\Desktop\Data Generator\input\purchase_sales.xls" -templates "C:\Users\MeleS\Desktop\Data Generator\input\Purch_Sales_Template.txt" -config "C:\Users\MeleS\Desktop\Data Generator\input\dd.properties" -out "C:\Users\MeleS\Desktop\Data Generator\output" -pairwise -f -isoNeg
 *
 * -- Branch coverage bases --
 * -dataspec "C:\RC\RCVIZ_EQ\DG\input\spec.xls" -templates "C:\RC\RCVIZ_EQ\DG\input\template_BC.txt" -config "C:\RC\RCVIZ_EQ\DG\input\dd.properties" -out "C:\RC\RCVIZ_EQ\DG\out" -branchgraph "C:\RC\RCVIZ_EQ\DG\input\spec.vdx" -allPaths -f
 *
 */
public class Caller {
