...
public class EquivalanceClassTransformerTest {
    ...
    public void testRegexEquivalanceClass() {
        ...
        Assert.assertTrue(thePipe.getPipeDelimited(outTemplate)
               + " VALUE NOT of syntax \\d{4}/\\d{2}/\\d{2}-\\d{2}:\\d{2}",
               (thePipe.getPipeDelimited(outTemplate).replaceAll("\\d{4}/\\d{2}/\\d{2}-\\d{2}:\\d{2}", "")).equals(""));


        //SAMPLE DATE
        thePipe.getDataMap()
                .put("TEST", "%regex(^(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\\d\\d$)");
        eqt.transform(thePipe);
        Assert.assertTrue(thePipe.getPipeDelimited(outTemplate)
                        + " VALUE NOT of syntax ^(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\\d\\d$",
                (thePipe.getPipeDelimited(outTemplate).
                        replaceAll("^(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\\d\\d$", ""))
                        .equals(""));
        ...
        eqt.transform(thePipe);
        Assert.assertTrue(thePipe.getPipeDelimited(outTemplate)
                        + " VALUE NOT of syntax ^([a-z0-9_\\.-]+)@([\\da-z\\.-]+)\\.([a-z\\.]{2,6})$",
                (thePipe.getPipeDelimited(outTemplate).
                        replaceAll("^([a-z0-9_\\.-]+)@([\\da-z\\.-]+)\\.([a-z\\.]{2,6})$", "")).equals(""));
