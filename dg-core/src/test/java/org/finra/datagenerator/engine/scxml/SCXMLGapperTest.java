...
public class SCXMLGapperTest {
    ...
    static String bigTest = "<scxml xmlns=\"http://www.w3.org/2005/07/scxml\"\n"
            + "       xmlns:ns=\"org.finra.datagenerator\""
            + "       version=\"1.0\"\n"
            + "       initial=\"start\">\n"
            + "\n"
            + "    <state id=\"start\">\n"
            ...
            + "        <onentry>\n"
            + "            <ns:set name=\"var_out_RECORD_TYPE\" range=\"a,b,c,d,e,f,g\"/>\n"
            + "            <ns:set name=\"var_out_RECORD_TYPE_2\" range=\"a,b,c,d,e,f,g\"/>\n"
            + "            <ns:set name=\"var_out_RECORD_TYPE_3\" range=\"a,b,c,d,e,f,g\"/>\n"
            ...
            + "        <onentry>\n"
            + "            <ns:set name=\"var_out_RECORD_TYPE_7\" range=\"1,2,3\"/>\n"
            + "            <ns:set name=\"var_out_RECORD_TYPE_8\" range=\"1,2,3\"/>\n"
            + "        </onentry>\n"
