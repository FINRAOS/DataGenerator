 ...
 */
public class PositiveBoundHiveVarchar extends BoundaryVarchar<PositiveBoundHiveVarchar.PositiveBoundHiveVarcharTag> {

    public Class<PositiveBoundHiveVarcharTag> getTagActionClass() {
        return PositiveBoundHiveVarcharTag.class;
    }

    public String getTagName() {
        return "positiveBoundHiveVarchar";
    }
     ...
     * to the variable
     */
    public List<Map<String, String>> pipelinePossibleStates(PositiveBoundHiveVarcharTag action,
                                            List<Map<String, String>> possibleStateList) {

        return returnStates(action, possibleStateList, buildVarcharData(action, true));
    }

    /**
     * A custom Action for the 'dg:positiveBoundHiveVarchar' tag inside models
     */
    public static class PositiveBoundHiveVarcharTag extends BoundaryActionVarchar {
        /**
         * constructor
         */
