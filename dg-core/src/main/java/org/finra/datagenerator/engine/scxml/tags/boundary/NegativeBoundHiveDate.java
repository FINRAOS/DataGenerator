 ...
 */
public class NegativeBoundHiveDate extends BoundaryDate<NegativeBoundHiveDate.NegativeBoundHiveDateTag> {

    public Class<NegativeBoundHiveDateTag> getTagActionClass() {
        return NegativeBoundHiveDateTag.class;
    }

    public String getTagName() {
        return "negativeBoundHiveDate";
    }
     ...
     * to the variable
     */
    public List<Map<String, String>> pipelinePossibleStates(NegativeBoundHiveDateTag action, List<Map<String, String>> possibleStateList) {
